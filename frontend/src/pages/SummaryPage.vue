            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    >
                        <h1>
                            Summary
                            <small class="text-muted">({{ selectedFilter.label }})</small>
                        </h1>
...
const setSelectedFilter = (event) => {
    Object.assign(selectedFilter, event)
}
onMounted(async () => {
    await fetchTasksSummary();
});
watch(() => selectedFilter.value.value, async (period) => await fetchTasksSummary({period}))
</script>
